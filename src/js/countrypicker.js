...
// country BOXes
function mapCountries(classname) {
    for (let items = 0; items < document.getElementsByClassName(classname).length; items++) {
        for (let i = 0; i < getJsonMaxSize(); i++) {
            var x = document.getElementsByClassName(classname)[items];
